...
function randomParagraph() {
    // getting random number and it'll always ess than the paragraph
    ...
    // focusing input field on keydown and click event
...
function initTyping() {
    ...
    if (charIndex < characters.length - 1 && timeLeft > 0) {
        if (!isTyping) { //once timer is start, it won't restart againon every key clicked
